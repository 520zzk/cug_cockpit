<template>
  <div class="left-chart-1">
   <div class="bc-chart-item">
      ...
      <div id="option_5" class="bottom-charts"></div>
...
export default {
  ...
  mounted () {
    this.myChart_1 = echarts.init(document.getElementById('option_5'))
    this.init()
  },
  methods: {
    init () {
      // IF-10.92.0.4.30000000001-30000019423 ae0-DianXin_IPRan 10.92.0.4 IPRan互联流量
      this.handleData('IF-10.92.0.4.30000000001-30000019423', this.option, this.myChart_1)
    },
