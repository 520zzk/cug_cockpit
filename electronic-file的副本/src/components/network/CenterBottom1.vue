  ...
  <div class="right-chart-1">
    ...
    <!-- <div class="rc1-chart-container">
      ...
      <div class="showItem" v-show="showItem" ref="showitem">
        <div class="showTitle"> 名称：<span class="showContent" v-html="showConten[0]"></span></div>
        <div class="showTitle">状态：<span class="showContent" v-html="showConten[1]"></span></div>
        <div class="showTitle">URL地址：<span class="showContent" v-html="showConten[2]"></span></div>
        <!-- <div class="showTitle">应答时间：<span class="showContent" v-html="showConten[3]"></span></div> -->
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  data () {
    return {
      config: {
        header: ['名称', '状态', 'URL地址'],
        // header: ['名称', '状态', 'URL地址', '应答时间'],
        columnWidth: ['100', '10%', '70%'],
        data: [],
        // index: true,
        // indexHeader: '序号',
        // columnWidth: [60],
